function Client_GameRefresh(game)
	...
	if not Mod.PlayerGameData.InitialPopupDisplayed and game.Us ~= nil then
		...
		UI.Alert("This game includes the King Of The Hills Mod. Capture all hills to win. The hills are" .. message .. "You can find them again by clicking on 'Game' and 'Mod: King Of The Hills'. Good Luck!")
		local payload = {};
